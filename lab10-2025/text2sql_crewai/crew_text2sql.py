...
def process_query(query):
    try:
        ...
        generation_task = create_generation_task(query_generator, query)
...
def main():
    parser = argparse.ArgumentParser(description='Text to SQL Converter')
    parser.add_argument('--query', type=str, help='Natural language query to convert to SQL')
    parser.add_argument('--interactive', action='store_true', help='Run in interactive mode')
    
    args = parser.parse_args()
    
    if args.interactive:
        print("Text to SQL Converter - Interactive Mode")
